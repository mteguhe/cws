...
class Trend extends CI_Controller {
	...
	function index()
	{
		echo "<meta http-equiv='refresh' content='0; url=".base_url()."trend/cari'>";
	}
	...
	function cari()
	{
		...
		$data['berita'] = $this->m_help_page->tampil_semua_berita($limit,$offset);
		$tot_hal = $this->m_help_page->hitung_isi_1tabel('tbl_intermezzo','');
		
		$config['base_url'] = base_url() . 'trend/cari/';
