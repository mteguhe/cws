...
<legend align="left"><strong>Form Tambah Promo :</strong></legend>
<form method="post" action="<?php echo base_url(); ?>admin/update_promo" enctype="multipart/form-data">
<input type="hidden" name="id" value="<?php echo $et['id_berita']; ?>" />
<input type="hidden" name="gbr" value="<?php echo $et['gambar']; ?>" />
<table width="100%">
	<tr><td width="150">Judul Promo</td><td>:</td><td><input type="text" name="judul" class="login-inp" size="90" value="<?php echo $et['judul']; ?>"> </td></tr>
	...
	<tr><td width="150" valign="top">Gambar</td><td valign="top">:</td><td><img src="<?php echo base_url(); ?>asset/promo/<?php echo $et['gambar']; ?>"  width="300"/></td></tr>
